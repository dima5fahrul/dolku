  ...
  return (
    <div className="h-screen">
      <div className="h-full flex flex-wrap items-center">
            ...
            <form action="" className="px-4 xl:px-25 sm:px-25 lg:px-50">
              ...
              <div className="mb-4">
                <button
                  onClick={onLogin}
                  type="submit"
                  className="flex w-full items-center justify-center gap-3.5 rounded-full border text-white border-stroke bg-green p-3 hover:bg-greendark dark:border-strokedark dark:bg-green dark:hover:bg-greendark"
                >
                  Sign In
                </button>
              </div>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3.5 rounded-full border border-stroke bg-gray p-3 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50"
              >
                <span>
                  <svg
                    width="20"
        ...
        <div className="hidden w-full h-full xl:block xl:w-1/2 bg-color-white bg-green">
          <div className="py-17.5 px-26 text-center">
            ...
            >
              ...
              <h1 className="text-white font-bold text-4xl ml-5">Dolku</h1>
            </Link>
