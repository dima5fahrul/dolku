...
import { collection, query, orderBy, getDoc, doc, getDocs  } from "firebase/firestore";
            ...
            <div className="mx-auto max-w-270">
                ...
                <div className="flex justify-center items-center">
                    <div className="w-1/2 2xsm:w-3/4 justify-self-center justify-center justify-items-center content-center items-center self-center rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        ...
                        <form id="form-upload" ref={myRef} onSubmit={sendEmail} action="#" method="post" encType="multipart/form-data">
                            <div className="p-6">
                                {report.map((items: any, id: any) => (
                                    <div key={id}>
                                        <div className="mb-5">
                                            <label className="mb-2.5 block text-black dark:text-white" htmlFor="question">
                                                Email User
                                            </label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="mb-5">
                                            <label className="mb-2.5 block text-black dark:text-white" htmlFor="userQuestion">
                                                Pertanyaan
                                            </label>
                                ...
                                {userData ? (
                                    <div className="mb-5 flex flex-col gap-6 sm:flex-row">
                                        <div className="w-full sm:w-1/2">
                                            <label className="mb-2.5 block text-black dark:text-white" htmlFor="adminName">
                                            Nama Admin
                                            </label>
                                            <input
                                            type="text"
                                        ...
                                        <div className="w-full sm:w-1/2">
                                            <label className="mb-2.5 block text-black dark:text-white" htmlFor="adminEmail">
                                            Email Admin
                                            </label>
                                            <input
                                            type="text"
                                ...
                                <div className="mb-5">
                                <label className="mb-2.5 block text-black dark:text-white" htmlFor="response">
                                    Respon
                                </label>
                                    <textarea
