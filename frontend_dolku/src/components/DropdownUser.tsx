  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 translate-x-4 lg:translate-x-6 mt-8 flex w-62.5 flex-col rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
