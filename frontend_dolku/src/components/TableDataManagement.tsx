...
const TableDataManagement = () => {
  ...
  return (
    <div className="min-h-125 rounded-lg border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <form>
        <div className="flex flex-auto mb-9 mt-2 items-center">
          ...
          {/* <NavLink
            ...
            className={`group max-h-12 rounded-lg flex items-center gap-2.5 py-2 px-6 font-medium text-white duration-300 ease-in-out bg-green hover:bg-greendark dark:hover:bg-greendark`}
          >
            + Add
          </NavLink> */}
        </div>
                    ...
                    <td className="border-b justify-center items-center border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:px-8 xl:py-6">
                      <div className="flex items-center space-x-3.5">
                        <button
                          ...
                          onClick={() => handleOpenDocument(items.pdf_path)}
                        >
                          <svg
                        ...
                        <button
                          className="hover:text-primary"
                          onClick={() => window.open(items.pdf_path, '_blank')}
                        >
                          <svg
                            className="fill-current"
                            width="18"
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleDeleteDocument(items.id, items.filename)
                          }
                        >
                          <svg
                            className="fill-current"
      ...
      <NavLink
        to="/data-management/create"
        className="fixed bottom-10 right-10 bg-green text-white w-16 h-16 rounded-full flex items-center justify-center"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="fill-current"
